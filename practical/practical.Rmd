...
Or, you can also fit rhw model with default priors and then pass that model object into the `prior_summary()` function: you'll get the same output from these two methods.
